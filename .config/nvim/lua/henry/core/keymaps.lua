...
-- Jump to current word in cursor
keymap.set("n", "n", "nzzzv")
keymap.set("n", "N", "Nzzzv")

-- Float Terminal
keymap.set("n", "<leader>ft", ":FloatermNew --name=myfloat --height=0.8 --width=0.7 --autoclose=2 fish <CR> ")
keymap.set("n", "<leader>tt", ":FloatermToggle myfloat<CR>")
-- Add a key mapping to close the Floaterm instance
keymap.set("t", "<S-ESC>", "<C-\\><C-n>:FloatermKill myfloat<CR>", { noremap = true, silent = true })
